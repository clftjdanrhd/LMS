...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.jsp" class="logo"><b>LMS<span>&nbsp; Global IT Business</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.jsp"><img src="/resources/img/ui-sam.jpg" class="img-circle" width="80"></a></p>
            ...
            <div class="row content-panel">
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p><img src="/resources/img/ui-sam.jpg" class="img-circle"></p>
                  <p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 detailed">
                        ...
                        <div class="row centered mb">
                          <ul class="my-friends">
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="/resources/img/friends/fr-01.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="/resources/img/friends/fr-02.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="/resources/img/friends/fr-03.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="/resources/img/friends/fr-04.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="/resources/img/friends/fr-05.jpg"></div>
                            </li>
                            <li>
                              <div class="friends-pic"><img class="img-circle" width="35" height="35" src="/resources/img/friends/fr-06.jpg"></div>
                            </li>
                            <li>
