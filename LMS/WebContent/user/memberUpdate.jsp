...
<body>
	<section id="container">
        ...
        *********************************************************************************************************************************************************** -->
		...
		<header class="header black-bg">
			...
			<!--logo start-->
			<a href="index.jsp" class="logo"><b>LMS<span>&nbsp;
						Global IT Business</span></b></a>
			<!--logo end-->
					...
					<li id="header_inbox_bar" class="dropdown"><a
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="index.jsp"> <span class="photo"><img
										alt="avatar" src="/resources/img/ui-zac.jpg"></span> <span
        ...
        *********************************************************************************************************************************************************** -->
						...
						<div class="row content-panel">
							<div class="col-md-4 profile-text mt mb centered">
								<div class="right-divider hidden-sm hidden-xs">
									<h4>${loginUser.userno}</h4>
									<h6>학번</h6>
									<h4>${loginUser.state}</h4>
									<h6>상태</h6>
									<h4>${loginUser.usertel}</h4>
									<h6>전화번호</h6>
								</div>
							</div>
							<!-- /col-md-4 -->
							...
							<div class="col-md-4 centered">
								<div class="profile-pic">
									<p>
										<img src="/resources/img/ui-sam.jpg" class="img-circle">
									</p>
									<p>
										<button class="btn btn-theme">
                    ...
                    <a data-toggle="tab" href="#contact" class="contact-map">Contact</a>
                          ...
                          <div class="pull-right">
                            <button class="btn btn-sm btn-theme03">POST</button>
														...
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-01.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-02.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-03.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-04.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-05.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-06.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-07.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-08.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-09.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-10.jpg">
															</div>
														</li>
														<li>
															<div class="friends-pic">
																<img class="img-circle" width="35" height="35"
																	src="/resources/img/friends/fr-11.jpg">
															</div>
														</li>
													</ul>
													<div class="row mt">
									...
									<!-- /tab-pane -->
									<div id="edit" class="tab-pane" align="center">
										<div class="row" >
											<div class="col-lg-8 col-lg-offset-2 detailed" align="center">
													...
													<div class="form-group">
														...
														<div class="col-lg-6">
															<input type="text" placeholder=" " id="c-name"
																class="form-control" value="${loginUser.userno }">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-6">
															<input type="text" placeholder=" " id="lives-in"
																class="form-control" value="${loginUser.username }">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-6">
															<input type="text" placeholder=" " id="country"
																class="form-control" value="${loginUser.state}">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-6">
															<input type="text" placeholder=" " class="form-control"
																id="" name="" value="${loginUser.usertel}">
														</div>
													</div>
												</form>
											</div>
												...
												<form role="form" class="form-horizontal">
													...
													<div class="form-group" align="center">
														<div class="col-lg-offset-2 col-lg-10">
															<input class="btn btn-theme" type="submit" value="수정" action="memberUpdate.do"></button>
		...
		<footer class="site-footer">
          ...
          -->
				...
				<a href="profile.jsp" class="go-top"> <i class="fa fa-angle-up"></i>
				</a>
			</div>
		</footer>
		<!--footer end-->
	...
	<script src="/resources/lib/jquery.nicescroll.js"
