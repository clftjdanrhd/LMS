              ...
              <span>공지사항</span></h3>
                           ...
                           <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                 <input class=" form-control" id="cname" name="noticeTitle"
                                    minlength="2" type="text" required  value="${notice.noticeTitle}"/>
                              </div>
                           </div>
                           <div class="form-group ">
                              <label for="cemail" class="control-label col-lg-2"><center>작성자</center></label>
                              <div class="col-lg-10">${notice.userName}</div>
                           </div>
                           ...
                           <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                 <textarea class="form-control " id="ccomment" name="noticeContent"
                                    rows="10px">${notice.noticeContent}</textarea>
                              </div>
                           </div>
                <div class="form-group">
                ...
                <div class="controls col-md-9">
                                          <input class="form-control" id="exampleInputEmail2"
                                             ...
                                             style="width: 200px;" value="${notice.noticePass }">
                                       </div>   
                                       </div>                     
<%--                            <div class="form-group">
                              <label class="control-label col-lg-2"><center>첨부파일</center></label>
                              <div class="controls col-md-9">
                                 <div class="form-group">
                                    <div class="fileupload fileupload-new"
                                       ...
                                       <span class="btn btn-theme02 btn-file"> 
                                          <span class="fileupload-new"><i class="fa fa-paperclip"></i> Select file</span> 
                                          <input class="default" type="file" style="display:none">
                                       </span> 
                                       <span class="fileupload-preview" style="margin-left: 5px;"></span>
                                       <a class="close fileupload-exists"
                                          style="margin-left: 5px; float: none;"
                                          href="advanced_form_components.html#"
                                          data-dismiss="fileupload"></a>
                                    </div>
                                 </div>
                                 </div>
                                 </div> --%>
 ...
 --%>
                ...
                <label for="cname" class="control-label col-lg-2"><center>비밀번호</center></label>
                <s class="col-lg-10">
                  <label class="sr-only" for="exampleInputPassword2">Password</label>
                  <input class="form-control" id="exampleInputPassword2" type="password" placeholder="Password" style="width:200px;">
                  </span>
              </span>
                           ...
                           <form class="form-inline" role="form">
                              ...
                              <div class="col-lg-10">
                                 <input class="form-control" id="exampleInputPassword2"
                                    type="password" placeholder="Password" style="width:200px;">
				...
				onclick="return noticeCheck()"> <input class="btn btn-theme04" type="reset"
