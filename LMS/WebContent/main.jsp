      ...
      <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 mb">
                <div class="green-panel pn">
                  ...
                  <canvas width="120" height="120" id="serverstatus03" style="width: 120px; height: 120px;"></canvas>
                  <script>
                    var doughnutData = [{
                        value: 60,
                        color: "#2b2b2b"
            ...
            <div class="row">
              <div class="col-md-4 col-sm-4 mb">
                ...
                <div class="green-panel pn">
                  ...
                  <div class="chart mt">
                    <div class="sparkline" data-data="[200,135,667,333,526,996,564,123,890,464,655]" data-spot-radius="4" data-highlight-line-color="#fff" data-fill-color="" data-spot-color="#fff" data-line-color="#fff" data-line-width="1" data-width="90%" data-height="75" data-resize="true" data-type="line"><canvas width="486" height="75" style="width: 486px; height: 75px; vertical-align: top; display: inline-block;"></canvas></div>
                  </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="weather-2 pn">
                  ...
                  <div class="row centered">
                    <img width="120" class="img-circle" src="img/ny.jpg">
                  </div>
                  <div class="row data">
                    <div class="col-sm-6 col-xs-6 goleft">
                      <h4><b>16 ºC</b></h4>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <p><img width="50" class="img-circle" src="img/ui-zac.jpg"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="steps pn">
                  <input name="op1" id="op1" type="checkbox" checked="">
                  <label for="op1">Update Profile</label>
                  <input name="op2" id="op2" type="checkbox">
                  <label for="op2">Contact Paul</label>
                  <input name="op3" id="op3" type="checkbox">
                  <label for="op3">Enjoy Life</label>
                  <input id="submit" type="submit" value="All Done!">
                </div>
              </div>
              <!-- /col-md-4 -->
              <!--  PROFILE 01 PANEL -->
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="content-panel pn">
                  <div id="profile-02">
                    <div class="user">
                      <img width="80" class="img-circle" src="img/friends/fr-06.jpg">
                      <h4>DJ SHERMAN</h4>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="product-panel-2 pn">
                  ...
                  <img width="200" alt="" src="img/product.jpg">
